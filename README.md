...
I’m a hands-on cybersecurity analyst with a passion for incident response, threat detection, and application security. I bring projects to life through real-world simulations from honeypots to SOAR integration. I’m always learning, building, and sharing. Currently completing my Bachelor’s in Computer Science and open to full-time Security Analyst and Security Engineering roles.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Application%20Security-informational?style=for-the-badge&color=blue" alt="Application Security"/>
...
|--------|-------------|----------------|
| [🧠 SOAR + EDR Lab](https://github.com/Moo4president/SOAR-EDR) | Simulated automated threat response integrating SOAR tools with EDR alerts | SOAR, EDR, Incident Response |
